...
//TESTIMONIALS
let  testimonials = [
    { quote: '"More than ever, pets are treated as members of the family"', origin: 'cbs.svg' },
    { quote: '"DogDev is a direct-to-consumer delivery service, prepared fresh with 100% real ingredients. Ingredients that humans would recognize"', origin: 'forbes.svg' },
    { quote: '"DogDev uses simple, clean ingredients in its dishes"', origin: 'fox.svg' },
    { quote: '"I see you as true hero"', origin: 'sharktank.svg' }
];
